                            ...
                            <li>
                                <div class='reset-char'>
                                    ...
                                    <div>
                                        ...
                                        ?>
                                            <span class="head">
                                                <img src="<?php bloginfo(template_url) ?>/images/cabelos/<?php echo $c->sex; ?>/cabelo-<?php echo ($c->hair+1); ?>.gif" class="<?php echo $fix; ?>" alt=""/>
                                            </span>
                                            <img src="<?php bloginfo(template_url) ?>/images/classes/<?php echo $c->sex; ?>/<?php echo $c->class; ?>.png" alt=""/>
                                        </section>
                                        <table>
                                            <thead>
                                                <tr>
