...
define('__ROOT__', dirname(__FILE__) . 'includes/chargen/'); 
...
//- Sql
Controller::$hostname =     $host;   	// Mysql Host
Controller::$database =     $database;	// Database Name
Controller::$username =     $user;		// Database Username
Controller::$password =     $userpass;	// Database Pass
/// -----------------------------------------------------------------
